  ...
  <div>
          ...
          <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
            <div class="heading relative mb-0 md:w-[725px]">
              ...
              >
                ...
                economy which uses Ethereum-based cryptocurrencies. Players of
                Axie Infinity collect and mint NFTs which represent
    ...
    <section class="py-14 md:py-[100px]">
      <div class="container">
        ...
        <div class="py-14 md:py-20">
          ...
          <ul
            class="list-disc space-y-4 font-semibold leading-6 ltr:ml-[18px] rtl:mr-[18px] md:text-lg ltr:md:pl-4 rtl:md:pr-4"
          >
        ...
        <div class="pb-14 md:pb-20">
          ...
          >
            ...
            automating data aggregation, analysis, and financial forecasting. In
            late 2021, we partnered to help them take charge of the Strategic
            Finance category with a new brand, voice, and web experience. To
            connect with their audience of finance leaders they needed to look
            and feel like a polished, confident, no-nonsense brand.
          </p>
          <p
          ...
          >
            ...
            visuals, Mosaic takes after its ideal user: the less meetings, more
            doing kinda folk. Tasked with bringing this new brand to life
    ...
    <section class="py-14 md:py-[100px] lg:py-[100px]">
      <project-slider>
        <template #title>
          <div
            class="heading mb-0 text-center ltr:lg:text-left rtl:lg:text-right"
          >
