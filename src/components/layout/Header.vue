            ...
            <ul @click="showMenu = false">
              ...
              <li class="group relative" @click.stop>
                ...
                >
                  Landing
                  <div
                    class="transition duration-500 group-hover:rotate-180 ltr:ml-2 rtl:mr-2"
                  >
                    <svg
                      width="24"
                      height="24"
                ...
                <div class="submenu" @click="showMenu = false">
                  ...
                  <router-link to="/creative-agency">
                    Creative Agency
                  </router-link>
              ...
              <li>
                <router-link
                  to="/portfolio"
                  :class="{ active: $route.name === 'portfolio-detail' }"
              ...
              <li>
                <router-link
                  to="/services"
                  :class="{ active: $route.name === 'services-detail' }"
                  >Service</router-link
                >
              </li>
              <li>
